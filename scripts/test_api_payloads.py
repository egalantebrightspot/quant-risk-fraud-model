...
def main():
    with httpx.Client(timeout=30.0) as client:
        ...
        print("=== POST /score?include_shap=true (with SHAP) ===")
        r = client.post(f"{BASE}/score", json=LOW_RISK, params={"include_shap": True})
        d = r.json()
        print("probability:", d.get("probability"), "risk_tier_letter:", d.get("risk_tier_letter"), "risk_tier_numeric:", d.get("risk_tier_numeric"))
        print("shap_values (top 3):", dict(list((d.get("shap_values") or {}).items())[:3]))
        print()
